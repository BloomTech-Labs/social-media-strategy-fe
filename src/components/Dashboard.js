...
const Dashboard = () => {
  ...
  return (
      ...
      <h4 className="highlight">Tuesday</h4> <h4 className="highlight"> • </h4><h4 className="date"> 16 March, 2020</h4>
      </div>
      ...
      <Card key={data.id} className={st.root}>
        ...
        <Typography variant="h3" className={st.name}>{e.firstName}{e.lastName}</Typography>
        <Typography variant="h4" className={st.handle}>{e.twitterHandle}</Typography>
