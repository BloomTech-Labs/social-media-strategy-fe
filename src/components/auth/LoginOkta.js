...
import { Grid, Hidden, makeStyles, AppBar, Toolbar, Button, CircularProgress } from '@material-ui/core';
    ...
    return ( authState.isAuthenticated ?
        ...
        <Grid container wrap='wrap' className={classes.root}>
            ...
            <Grid item xs className={classes.widgetContainer}>
                <Hidden mdDown>
                    <Button onClick={handleLogoClick} style={{position: 'absolute', top:'.8em', left:'.8em'}}>
